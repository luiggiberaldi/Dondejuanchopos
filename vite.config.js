...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    plugins: [
      react(),
    VitePWA({
      registerType: 'autoUpdate', // Auto-actualización transparente de nuevas versiones desplegadas en Vercel
      includeAssets: ['favicon.ico', 'apple-touch-icon-180x180.png', 'pwa-192x192.png', 'pwa-512x512.png', 'logo.png', 'logodark.png'],
      workbox: {
        cleanupOutdatedCaches: true,
        skipWaiting: true, // Forzar activación del nuevo SW inmediatamente al desplegar en Vercel
        clientsClaim: true,
